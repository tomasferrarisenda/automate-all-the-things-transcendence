...
EL CERTI NO FUNCIONABA PORQ EL INGRESS ORIGINAL NO DEJBA QUE SE LLEGUE AL POD DEL CERTIFICADO. EL INGRESS CREADO POR EL CERT APUNTABA AL POD CORRECTO PERO AL EXISTIR EL INGRESS ORIGINAL, ESTE HACIA Q LOS REQUEST SEAN INTERCEPTADOS ANTES Y ENVIADOS AL POD DE GRFANA EN ESDTE CASO, EN LUGAR DE AL POD DEL HTTP01 SOLVER.

PARA SOLUCIONARLO CREAMOS UN NUEVO BACKEND PATH QUE APUNTA A UN NUEVO SERVICIO CREADO A MANO Y ESTE SERVICIO APUNTA AL POD DE SOLVER UTILIZANDO UN SELECTOR.
...
LA VALIDACION DE ESTE CERT ES POR DNS, POR LO Q HAY Q VER COMO AUTOMATIZAR LA CREACION DEL RECORD SOLICITADO EN LA HOSTED ZONE. SE PODRA HACER CON TF? O SINO AWS CLI
